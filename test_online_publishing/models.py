...
class Log(models.Model):
    ...
    operate_type = models.ForeignKey(to='OperateType', on_delete=True, db_constraint=False, verbose_name='操作类型（1：开发提交任务；5：更新到本地环境；10：更新到dev环境；15：更新到dev2环境; 20：更新到生产环境）')
